...
if __name__ == "__main__":
    ...
    datamanager = DataManager("remote", cil_path, shuffle=False, seed=0, init_cls=10, increment=2, use_path=True, attr_path=os.path.join(cil_path, "Attribute0421.xlsx"))
    ...
    for session in range(3):
        tset, trainloader, testloader = get_cil_dataloader(cfg, datamanager, session=session)
        data_sample = tset[0]
