...
def get_command_line_parser():
    ...
    parser.add_argument('-dataset', type=str, default='remote',
                        choices=['mini_imagenet', 'cub200', 'cifar100','remote'])
    parser.add_argument('-dataroot', type=str, default='')

    # about pre-training
    parser.add_argument('-epochs_base', type=int, default=100)
    parser.add_argument('-epochs_new', type=int, default=100)
    parser.add_argument('-lr_base', type=float, default=0.002)
    ...
    parser.add_argument("-num_crops", type=int, default=[2, 4], nargs="+",  help="amount of crops")
    parser.add_argument("-size_crops", type=int, default=[224, 96], nargs="+", help="resolution of inputs")
    parser.add_argument("-min_scale_crops", type=float, default=[0.14, 0.05], nargs="+", help="min area of crops")
    parser.add_argument("-max_scale_crops", type=float, default=[1, 0.14], nargs="+",help="max area of crops")
    parser.add_argument('-constrained_cropping',action='store_true', help='condition small crops on key crop')
    parser.add_argument('-auto_augment', type=int, default=[], nargs='+', help='Apply auto-augment 50 % of times to the selected crops')
    parser.add_argument('-fantasy', type=str, default='rotation2', help='fantasy method to generate virtual classes')
    parser.add_argument('-alpha', type=float, default=1.0, help='coefficient of the global contrastive loss')
    parser.add_argument('-beta', type=float, default=0, help='coefficient of the local contrastive loss')
    ...
    # for data
    parser.add_argument('-split_file_train', type=str, default='/xxx/xx/xx/')
    parser.add_argument('-split_file_test', type=str, default='/xxx/xx/xx/')
    parser.add_argument('-base_class', type=int, default=11)
    ...
    parser.add_argument('-incft', default=False,help='incrmental finetuning')
