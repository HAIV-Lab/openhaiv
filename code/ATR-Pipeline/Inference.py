...
if __name__ == '__main__':
    ...
    batch = {'imgpath': ['/new_data/dx450/Project/zzh_ood/NCD_Attr_zzh/data/Benckmark/test/01/0011.jpg',
                         '/new_data/dx450/Project/zzh_ood/NCD_Attr_zzh/data/Benckmark/test/01/0011.jpg'],
