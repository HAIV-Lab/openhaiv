...
def load_clip_to_cpu(backbone_name, local_path=None):
...
def load_clip_to_cpu_locoop(backbone_name, local_path=None):
    if local_path is not None:
        model_path = local_path
    else:
...
def load_clip_to_cpu_dpm(backbone_name, local_path=None):
    if local_path is not None:
        model_path = local_path
    else:
