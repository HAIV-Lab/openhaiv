...
class DERHook(AlgHook):
    ...
    def after_train(self, trainer) -> None:
        ...
        trainer.model.update_fc(
            trainer.cfg.CIL.way * (trainer.session + 1) + trainer.cfg.CIL.base_classes
        )
    ...
    def train_step(self, trainer, data, label, attribute, imgpath):
        ...
        if session >= 1:
            ...
            aux_labels = torch.where(
                aux_labels - known_class + 1 > 0, aux_labels - known_class + 1, 0
            )
